package org.firstinspires.ftc.teamcode.FTC2023;//this is actually left
...
public class Test_auto_right_far extends Nav {
...
//public void turn_to_heading(double target_heading) {
    ...
    public void runOpMode() {
        ...
        */
        ...
        smallgo(0,0.5);
        sleep(2000);
        if (pos==1) go_sideways(270,270,0.5,36);
        if (pos==2) go_sideways(270,270,0.5,13);
        if (pos==3) go_sideways(90,90,0.5,11);
        /*GIVE UP CONE 2
        biggo(3000,0.8);
        smallgo(-380,1);
        //smallgo(0,0.3);
