...
@Autonomous(name="Test_auto_right_far", group="FTC 2023")

public class DONOT_Test_auto_right_far extends Nav {
...
//public void turn_to_heading(double target_heading) {
    ...
    public void runOpMode() {
        ...
        smallgo(-3000,1);
        go_sideways(90,0,0.5,50);
        go_sideways(270,0,0.5,10);
        turn_to_heading(90);
        //biggo(7200,1);
        go_sideways(270,90,0.5,10+PILLAR_LEFT);//first pillar go left
        //sleep(3000);
        go_forward(7.5+PILLAR_FRONT,90,0.5,false);//CONSTANT ALERT
        go_forward(0.5,90,0.2,false);//yes
        sleep(1000);
        smallgo(-2000,1);
        //sleep(500);
        robot.Intake.setPosition(0.97);
        ...
        smallgo(-3000,1);
        sleep(500);
        go_sideways(180,90,0.5,5.5+PILLAR_FRONT);
        //smallgo(-3000,1);
        ...
        */
        ...
        //smallgo(0,0.3);
        sleep(3200);
        go_sideways(90,90,0.5,8+PILLAR_LEFT);
        //sleep(2000);
        //sleep(10000);
        turn_to_heading(180);
        
        //sleep(100000);
        go_sideways(90,180,0.5,1);
        go_forward(27,180,0.4,false);
        go_forward(5,180,0.15,false);
        go_sideways(180,180,0.2,0.2);
        smallgo(0,1);
        biggo(2500,0.5);
        sleep(1000);
        //sleep(100000000);
        ...
        turn_to_heading(90);
        go_sideways(270,90,1,10+PILLAR_LEFT);
        
        go_forward(8,90,1,false);
        go_forward(3.3,90,1,false);//CONSTANT ALERT
        sleep(1000);
        smallgo(-2000,1);
        sleep(500);
        robot.Intake.setPosition(0.97);
